...
SRCS+=$(KTOP)/filetable/filetable.c
...
SRCS+=$(KTOP)/pidtable/pid.c
SRCS+=$(KTOP)/proc/proc.c
SRCS+=$(KTOP)/syscall/loadelf.c
SRCS+=$(KTOP)/syscall/runprogram.c
SRCS+=$(KTOP)/syscall/sys___getcwd.c
SRCS+=$(KTOP)/syscall/sys__exit.c
SRCS+=$(KTOP)/syscall/sys_chdir.c
SRCS+=$(KTOP)/syscall/sys_close.c
SRCS+=$(KTOP)/syscall/sys_dup2.c
SRCS+=$(KTOP)/syscall/sys_execv.c
SRCS+=$(KTOP)/syscall/sys_fork.c
SRCS+=$(KTOP)/syscall/sys_getpid.c
SRCS+=$(KTOP)/syscall/sys_lseek.c
SRCS+=$(KTOP)/syscall/sys_open.c
SRCS+=$(KTOP)/syscall/sys_read.c
SRCS+=$(KTOP)/syscall/sys_sbrk.c
SRCS+=$(KTOP)/syscall/sys_waitpid.c
SRCS+=$(KTOP)/syscall/sys_write.c
...
SRCS.MACHINE.mips+=$(KTOP)/vm/clevervm.c
